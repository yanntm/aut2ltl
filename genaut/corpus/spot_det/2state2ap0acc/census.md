...
- polarity/name twins folded: 2673
- **kept (AP-canonical determinized forms): 8639**
- TGBA-to-det collapse: 1.34x
- distinct languages (semantic `𝓘` dedup, see `det`/`sos`): 11312  → det-to-language 0.76x
