...
- polarity/name twins folded: 4
- **kept (AP-canonical determinized forms): 54**
- TGBA-to-det collapse: 1.81x
- distinct languages (semantic `𝓘` dedup, see `det`/`sos`): 58  → det-to-language 0.93x
