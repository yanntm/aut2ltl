"""
kr/gap/bridge.py — Generate, run, and high-level orchestration for SgpDec holonomy decompositions.
...
from .parse import parse_cascade_output  # focused parser service (keeps this file smaller)
...
def generate_gap_script(
    ...
    *,
    ...
    lines.append('# Auto-generated by BuchiToLTL/kr/gap/bridge.py')
...
# did "from aut2ltl.kr.gap.bridge import parse_cascade_output".
from .parse import parse_cascade_output  # noqa: F401
