...
- **Integrate V4, and fix paper §8's corpus.** §8.5's ⟨TBD⟩ is answered by report
  findings F15–F19. Every *other* number in §8 is report-era 3938 against today's
  6222 corpus; the report's *For theory* section states what to do. Until §9.4
  runs, the report — not the paper — is the source of truth for every measured
  value.
